...
void BSixCand::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BToKEE_BDT", BToKEE_BDT, &b_BToKEE_BDT);
   ...
   fChain->SetBranchAddress("BToKEE_iso04", BToKEE_iso04, &b_BToKEE_iso04);
   ...
   fChain->SetBranchAddress("BToKEE_ptImb", BToKEE_ptImb, &b_BToKEE_ptImb);
   fChain->SetBranchAddress("BToKEE_ptN", BToKEE_ptN, &b_BToKEE_ptN);
   ...
   fChain->SetBranchAddress("BToKEE_l1_ptN", BToKEE_l1_ptN, &b_BToKEE_l1_ptN);
   fChain->SetBranchAddress("BToKEE_l2_ptN", BToKEE_l2_ptN, &b_BToKEE_l2_ptN);
   ...
   fChain->SetBranchAddress("BToKEE_l1_dxySig", BToKEE_l1_dxySig, &b_BToKEE_l1_dxySig);
   fChain->SetBranchAddress("BToKEE_l2_dxySig", BToKEE_l2_dxySig, &b_BToKEE_l2_dxySig);
   ...
   fChain->SetBranchAddress("BToKEE_k_ptN", BToKEE_k_ptN, &b_BToKEE_k_ptN);
   ...
   fChain->SetBranchAddress("BToKEE_k_dxySig", BToKEE_k_dxySig, &b_BToKEE_k_dxySig);
   fChain->SetBranchAddress("BToKEE_DeltaZ", BToKEE_DeltaZ, &b_BToKEE_DeltaZ);
