...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nElectron;
   Float_t         Electron_dxy[150];   //[nElectron]
   Float_t         Electron_dxyErr[150];   //[nElectron]
   Float_t         Electron_dz[150];   //[nElectron]
   Float_t         Electron_dzErr[150];   //[nElectron]
   Float_t         Electron_eta[150];   //[nElectron]
   Float_t         Electron_fBrem[150];   //[nElectron]
   Float_t         Electron_ip3d[150];   //[nElectron]
   Float_t         Electron_mass[150];   //[nElectron]
   Float_t         Electron_mvaId[150];   //[nElectron]
   Float_t         Electron_pfRelIso[150];   //[nElectron]
   Float_t         Electron_pfmvaId[150];   //[nElectron]
   Float_t         Electron_phi[150];   //[nElectron]
   Float_t         Electron_pt[150];   //[nElectron]
   Float_t         Electron_ptBiased[150];   //[nElectron]
   Float_t         Electron_sip3d[150];   //[nElectron]
   Float_t         Electron_trkRelIso[150];   //[nElectron]
   Float_t         Electron_unBiased[150];   //[nElectron]
   Float_t         Electron_vx[150];   //[nElectron]
   Float_t         Electron_vy[150];   //[nElectron]
   Float_t         Electron_vz[150];   //[nElectron]
   Int_t           Electron_charge[150];   //[nElectron]
   Int_t           Electron_pdgId[150];   //[nElectron]
   Bool_t          Electron_convVeto[150];   //[nElectron]
   Bool_t          Electron_isLowPt[150];   //[nElectron]
   Bool_t          Electron_isPF[150];   //[nElectron]
   Bool_t          Electron_isPFoverlap[150];   //[nElectron]
   UInt_t          nGenPart;
   ...
   Int_t           Electron_genPartIdx[150];   //[nElectron]
   Int_t           Electron_genPartFlav[150];   //[nElectron]
